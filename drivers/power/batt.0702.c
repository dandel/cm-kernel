...
#define IMAP_ADAPTER 606
#define IMAP_BAT_FULL 600
//#define IMAP_BAT_CRITICAL 537
#define IMAP_BAT_CRITICAL 495
...
*/
       ...
       if (ischargingfull()&&batt>630){//charging
		adaptor_disconnect_num =0;
		if (battery_state == BATT_INITIAL){
		//		printk("batt is %d\n",batt);
                                old_batt = batt;
