...
\********************************************/
	...
	ret = IIC_Write(OV2655_I2C_WADDR, (unsigned char *)(ov2655_302d), SENSOR_OV2655);
	ret = IIC_Write(OV2655_I2C_WADDR, (unsigned char *)(ov2655_302e), SENSOR_OV2655);
	//printk(" ov2655_302d %x\n ov2655_302e %x\n", ov2655_302d->value, ov2655_302e->value);
	if(ret)
	{
		camif_error("Failed to transfer data to i2c\n");
		return -1;
...
static int imapx200_cam_ov2655_to_preview_320_240(void)
{
	int i, ret;
	char reg0x3013;
	...
	{
		ret = IIC_Write(OV2655_I2C_WADDR, (unsigned char *)(&ov2655_to_preview_320_240_regs[i]), SENSOR_OV2655);
		if(ret)
		{
			camif_error("Failed to transfer data to i2c\n");
			return -1;
...
static int imapx200_cam_ov2655_to_preview_640_480(void)
{
	int i, ret;
	char reg0x3013;
	struct ov2655_regval_list ov2655_3013[] = {
	...
	{
		ret = IIC_Write(OV2655_I2C_WADDR, (unsigned char *)(&ov2655_to_preview_640_480_regs[i]), SENSOR_OV2655);
		if(ret)
		{
			camif_error("Failed to transfer data to i2c\n");
			return -1;
		...
		case SENSOR_SET_MODE:
			...
			switch(value)
			{
				...
				case SENSOR_TO_HIGH_PREVIEW:
					imapx200_cam_ov2655_to_preview_640_480();
					break;
				case SENSOR_TO_LOW_PREVIEW:
					imapx200_cam_ov2655_to_preview_320_240();
					break;
				case CLOSE_SENSOR:
#ifdef CONFIG_OV2655
